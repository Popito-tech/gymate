...
function Testimonials() {
  return (
      <section className="my-[10rem] mx-auto">
        <div className="container page-padding">
          ...
          <div className="border-[#efefef] mt-[17rem] md1000:mt-[9rem] bg-white border-solid border-[9px] p-[30px] min540:h-[48rem] min375:h-[60rem]">
            <div className="bg-black overflow-x-clip w-full h-[33rem] relative">
              ...
              <img
                alt="girl_img"
                src='/images/testimonials/testimonial-new.jpg'
        ...
        >
          <img
            src='/images/testimonials/logo1.png'
            alt="logo"
            className="scale-[.8] hover:invert"
            style={{ transition: "all 0.3s" }}
          />
          <img
            src='/images/testimonials/logo2.png'
            alt="logo"
            className=" scale-[.8] hover:invert"
            style={{ transition: "all 0.3s" }}
          />
          <img
            src='/images/testimonials/logo3.png'
            alt="logo"
            className=" scale-[.8] hover:invert"
            style={{ transition: "all 0.3s" }}
          />
          <img
            src='/images/testimonials/logo4.png'
            alt="logo"
            className=" scale-[.8] hover:invert"
            style={{ transition: "all 0.3s" }}
          />
          <img
            src='/images/testimonials/logo5.png'
            alt="logo"
            className=" scale-[.8] hover:invert"
            style={{ transition: "all 0.3s" }}
          />
